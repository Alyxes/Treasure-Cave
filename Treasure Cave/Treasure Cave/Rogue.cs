namespace TreasureCave
{
    public class Rogue : Hero
    {
        ...
        public Rogue()
        {
            // Creates a class Rogue Hero, randomizes their stats.
            randGender(this);
            ...
            do
            {
                ...
                addedStaminaPoints = UsePoints(Game.randomize.Next(2, 5), this); // ++
                addedHealthPoints = UsePoints(Game.randomize.Next(2, 4), this); // +
                addedStrengthPoints = UsePoints(Game.randomize.Next(1, 3), this);
            ...
            isDualWielding = Game.RandomizeBool(3);
